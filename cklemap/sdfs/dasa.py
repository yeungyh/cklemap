...
class DASAExpLM(DASAExp):
    ...
    def __init__(self, solvefun, objfun, obj_sens_state, obj_sens_param, res_sens_state, res_sens_param, jac_size, top_size, init_jac=True):
        super().__init__(solvefun, objfun, obj_sens_state, obj_sens_param, res_sens_state, res_sens_param)
    ...
    def grad(self, p):
        ...
        #print(f'adj time elasped: {perf_counter() - time_start_all}')
...
class DASAExpLMAMPS(DASAExpLM):
    def __init__(self, solvefun, objfun, obj_sens_state, obj_sens_param, res_sens_state, res_sens_param, state_sens_param, jac_size, top_size):
        super().__init__(solvefun, objfun, obj_sens_state, obj_sens_param, res_sens_state, res_sens_param, jac_size, top_size)
    ...
    def grad(self, p):
        ...
        self.dLdp_time += perf_counter() - time_start
        time_start = perf_counter()
        self.jac[:self.top_size, :] = self.state_sens_param(dLdp)
...
class DASAExpKL(DASAExpLM):
    ...
    def __init__(self, solvefun, objfun, obj_sens_state, obj_sens_param, res_sens_state, res_sens_param, jac_size, top_size, const_term, param_sens_coeff):
        super().__init__(solvefun, objfun, obj_sens_state, obj_sens_param, res_sens_state, res_sens_param, jac_size, top_size, False)
    ...
    def grad(self, xi):
        #time_start = perf_counter()
        sens = super().grad(self.p)
        #print(f'sens time elasped: {perf_counter() - time_start}')
        #time_start = perf_counter()
        jac = sens @ self.param_sens_coeff
        #print(f'grad time elasped: {perf_counter() - time_start}')
        return jac
...
class DASAExpKLAMPS(DASAExpKL):
    def __init__(self, solvefun, objfun, obj_sens_state, obj_sens_param, res_sens_state, res_sens_param, state_sens_param, jac_size, top_size, const_term, param_sens_coeff):
        super().__init__(solvefun, objfun, obj_sens_state, obj_sens_param, res_sens_state, res_sens_param, jac_size, top_size, const_term, param_sens_coeff)
        self.state_sens_param = state_sens_param
    ...
    def grad(self, xi):
        ...
        self.dLdp_time += perf_counter() - time_start
        time_start = perf_counter()
        dudp = self.state_sens_param(dLdp)
        self.grad_time += perf_counter() - time_start
        #print(f'amps time elasped: {perf_counter() - time_start_all}')
        self.jac[:self.top_size, :] = dudp @ self.param_sens_coeff
        return self.jac
